...
<div class="btn-group pull-right">
 ...
 <!--   <li><a href="report/inventary-word.php?stock_id=<?php echo $stock->id; ?>">Word (.docx)</a></li>-->
    <li><a href="report/inventary-xlsx.php?stock_id=<?php echo $stock->id; ?>">Excel (.xlsx)</a></li>
