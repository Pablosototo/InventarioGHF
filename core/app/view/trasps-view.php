			...
			<?php else : ?>
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="report/trasptotal-xlsx.php">Excel (.xlsx)</a></li>
					</ul>
					...
					<div class="box-body">
						<table class="table table-bordered table-hover table-responsive datatable">
							...
							?>
								...
								<tr>
									<td style="width:30px;">
										<a href="index.php?view=onetraspase&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open"></i></a>
									</td>
									...
									<td>
										...
										echo "<b>" . Core::$symbol . " " . number_format($suma, 2, ".", ",") . "</b>";
										?>
									</td>
	...
	function thePDF() {
		...
		var rows = [
			...
			?> {
					...
					"total": "<?php echo Core::$symbol . " " . number_format($suma2, 2, ".", ","); ?>",
