                        ...
                        <div class="col-lg-12">
                          ...
                          <select name="client_id" id="client_id" class="form-control">
                            ...
                            <?php foreach ($clients as $client) : ?>
                              <option value="<?php echo $client->id; ?>" <?php if ($client->id == $sell->person_id) {
                                                                          echo "selected";
                        ...
                        <div class="col-lg-12">
                          ...
                          <select name="f_id" id="p_id" class="form-control">
                            <?php foreach (FData::getAll() as $client) : ?>
                              <option value="<?php echo $client->id; ?>" <?php if ($client->id == $sell->f_id) {
                                                                          echo "selected";
    ...
    <script type="text/javascript">
      ...
      function theInvoice() {
       ...
       // <?php endif; ?>
        ...
        doc.text("FACTURA: #<?php echo $sell->id; ?>", 420, 35);
        doc.text("FECHA: <?php echo $sell->created_at; ?>", 420, 45);
        //        doc.text("Operador:", 40, 150);
        //        doc.text("Header", 40, 30);
        //      doc.text("Header", 40, 30);
        doc.line(40, 58, 560, 58);
        <?php if ($sell->person_id != "") :
          $person = $sell->getPerson();
        ?>
          doc.text("CLIENTE: <?php echo $person->name . " " . $person->lastname; ?>", 40, 85);
         // doc.text("RUT/RFC: <?php echo $person->no; ?>", 40, 100);
          doc.text("DIRECCION: <?php echo $person->address1; ?>", 40, 100);
          doc.text("TELEFONO: <?php echo $person->phone1; ?>", 40, 115);
        ...
        doc.autoTable(columns, rows, {
          ...
          //img.src = "liberacion2.jpg";
          //doc.addImage(img, 'JPEG', 40, 10, 610, 100, 'monkey'); // Cache the image using the alias 'monkey'
          doc.setFontSize(20); doc.setFontSize(12);
